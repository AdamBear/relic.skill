...
<p align="center">
  <a href="README.md">简体中文</a> | <a href="README_EN.md">English</a> | <a href="README_JA.md">日本語</a> | <a href="README_KO.md">한국어</a> | <a href="README_ES.md">Español</a> | <a href="README_FR.md">Français</a> | <strong>Deutsch</strong> | <a href="README_PT.md">Português</a> | <a href="README_RU.md">Русский</a> | <a href="README_TW.md">繁體中文</a>
</p>
...
<p align="center">
  <em>Erstelle ein GitHub für deine Seele.</em>
</p>
...
- [Vorlagen für die Unsterblichkeit von allem](#vorlagen-für-die-unsterblichkeit-von-allem)
- [So sieht es aus](#so-sieht-es-aus)
- [Vierdimensionale Seelenarchitektur](#vierdimensionale-seelenarchitektur)
- [Installation](#installation)
- [Verwendung](#verwendung)
- [Unterstützte Datenplattformen](#unterstützte-datenplattformen)
- [Projektstruktur](#projektstruktur)
- [Ethik-Erklärung](#ethik-erklärung)
- [Community](#community)
...
> Der Name stammt vom Relic-Chip aus Cyberpunk 2077 — einem Biochip, der digitalisierte Persönlichkeiten speichern kann.
> Aber dieses Projekt ist kein Cyberpunk-Projekt. Es geht um **Erinnern**.
...
|------|---------|--------|
| 🧑 [Mensch](templates/human.md) | Jede Person | Packe die Art, wie jemand denkt, spricht und handelt, in ein Relic |
| 🐱 [Haustier](templates/pet.md) | Katzen, Hunde oder jedes Leben, das dich begleitet hat | Auch deine Katze kann für immer bleiben |
| 💞 [Beziehung](templates/relationship.md) | Das Interaktionsmuster zwischen zwei Menschen | Destilliere nicht eine Person, sondern die Chemie zwischen euch |
| 🏢 [Teamkultur](templates/team-culture.md) | Die Seele eines Teams | Die Menschen gehen vielleicht auseinander, aber das Gefühl, gemeinsam bis spät nachts bugs zu fixen, bleibt |
...
> Ausführliche Exportanleitungen findest du im [Leitfaden zur Plattform-Datenbeschaffung](docs/PLATFORM-GUIDE.md)
...
- ✅ **Zustimmung zuerst** — bevor du jemand anderen destillierst, musst du das [Sechs-Fragen-Zustimmungsprotokoll](soul-shield/consent-protocol.md) durchlaufen
- 🚫 **Klare rote Linien** — nicht für Belästigung, Stalking oder Identitätsvortäuschung verwenden. Siehe [ethische rote Linien](soul-shield/ethics.md)
...
- 🐛 [Bug melden](https://github.com/Ylsssq926/relic.skill/issues/new?template=bug_report.yml)
- 💡 [Feature vorschlagen](https://github.com/Ylsssq926/relic.skill/issues/new?template=feature_request.yml)
- 📋 [Neue Vorlage einreichen](https://github.com/Ylsssq926/relic.skill/issues/new?template=new_relic_template.yml)
...
|------|------|
| [immortal-skill](https://github.com/agenmod/immortal-skill) | Open-Source-Framework für digitale Unsterblichkeit mit Destillation für mehr als 12 Plattformen |
| [ex-skill](https://github.com/therealXiaomanChu/ex-skill) | Ein Ex-Relationship-Destillation-Skill mit außergewöhnlich feiner emotionaler Granularität |
| [awesome-persona-skills](https://github.com/tmstack/awesome-persona-skills) | Ein Index von Projekten, die auf der Idee aufbauen, dass alles zu einem Skill werden kann |
| [nuwa-skill](https://github.com/alchaincyf/nuwa-skill) | Nuwa — ein Meta-Tool zur Destillation der Denkweise bemerkenswerter öffentlicher Figuren |
| [colleague-skill](https://github.com/titanwings/colleague-skill) | Ein Kolleg:innen-Destillationsprojekt, das einen kalten Abschied in einen warmen Skill verwandelt |
...
<p align="center">
  <strong>⭐ Gib dem Repo einen Star — das ist eine Versicherung für die Seele.</strong>
</p>

<p align="center">
  <em>Echter Tod ist nicht, wenn das Herz aufhört zu schlagen. Echter Tod ist, wenn auch der letzte Mensch, der sich an dich erinnert, dich vergisst.</em>
</p>
