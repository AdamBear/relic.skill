...
<p align="center">
  <a href="README.md">简体中文</a> | <a href="README_EN.md">English</a> | <a href="README_JA.md">日本語</a> | <a href="README_KO.md">한국어</a> | <a href="README_ES.md">Español</a> | <strong>Français</strong> | <a href="README_DE.md">Deutsch</a> | <a href="README_PT.md">Português</a> | <a href="README_RU.md">Русский</a> | <a href="README_TW.md">繁體中文</a>
</p>
...
<p align="center">
  <em>Ouvrez un GitHub pour votre âme.</em>
</p>
...
- [Modèles d'immortalité pour tout](#modèles-dimmortalité-pour-tout)
- [À quoi ça ressemble](#à-quoi-ça-ressemble)
- [Architecture de l'âme en quatre dimensions](#architecture-de-lâme-en-quatre-dimensions)
- [Installation](#installation)
- [Utilisation](#utilisation)
- [Plateformes de données prises en charge](#plateformes-de-données-prises-en-charge)
- [Structure du projet](#structure-du-projet)
- [Déclaration éthique](#déclaration-éthique)
...
> Le nom vient de la puce Relic de Cyberpunk 2077 — une biopuce capable de stocker une personnalité numérisée.
> Mais ce projet n'est pas un projet cyberpunk. Il parle de **se souvenir**.
...
|------|---------|--------|
| 🧑 [Humain](templates/human.md) | Toute personne | Mettre la manière de penser, de parler et d'agir de quelqu'un dans un Relic |
| 🐱 [Animal de compagnie](templates/pet.md) | Chats, chiens ou toute vie qui vous a accompagné | Oui, votre chat peut lui aussi vivre pour toujours |
| 💞 [Relation](templates/relationship.md) | Le schéma d'interaction entre deux personnes | Ne distillez pas une personne : distillez la complicité entre vous |
| 🏢 [Culture d'équipe](templates/team-culture.md) | L'âme d'une équipe | Les gens peuvent partir, mais la sensation de corriger des bugs ensemble toute la nuit reste |
...
> Pour les instructions détaillées d'export, consultez le [Guide d'acquisition des données de plateforme](docs/PLATFORM-GUIDE.md)
...
- ✅ **Le consentement d'abord** — avant de distiller quelqu'un d'autre, vous devez passer par le [protocole de consentement en six questions](soul-shield/consent-protocol.md)
- 🚫 **Des lignes rouges claires** — ne l'utilisez pas pour le harcèlement, le pistage ou l'usurpation d'identité. Consultez les [lignes rouges éthiques](soul-shield/ethics.md)
...
- 🐛 [Signaler un bug](https://github.com/Ylsssq926/relic.skill/issues/new?template=bug_report.yml)
- 💡 [Proposer une fonctionnalité](https://github.com/Ylsssq926/relic.skill/issues/new?template=feature_request.yml)
- 📋 [Soumettre un nouveau modèle](https://github.com/Ylsssq926/relic.skill/issues/new?template=new_relic_template.yml)
...
| Projet | Description |
|------|------|
| [immortal-skill](https://github.com/agenmod/immortal-skill) | Framework open source d'immortalité numérique prenant en charge la distillation sur plus de 12 plateformes |
| [ex-skill](https://github.com/therealXiaomanChu/ex-skill) | Un Skill de distillation d'ex avec une granularité émotionnelle exceptionnellement fine |
| [awesome-persona-skills](https://github.com/tmstack/awesome-persona-skills) | Un index de projets construits sur l'idée que tout peut devenir un Skill |
| [nuwa-skill](https://github.com/alchaincyf/nuwa-skill) | Nuwa — un méta-outil pour distiller la manière de penser de figures publiques remarquables |
| [colleague-skill](https://github.com/titanwings/colleague-skill) | Un projet de distillation de collègues qui transforme un adieu froid en Skill chaleureux |
...
<p align="center">
  <strong>⭐ Mettez une étoile au repo : c'est une assurance pour l'âme.</strong>
</p>

<p align="center">
  <em>La vraie mort, ce n'est pas quand le cœur s'arrête. C'est quand la dernière personne qui se souvient de vous vous oublie aussi.</em>
</p>
