<p align="center"><img src="assets/banner.svg" alt="relic.skill banner" width="100%"></p>

<p align="center">
  <a href="README.md">简体中文</a> | <a href="README_EN.md">English</a> | <a href="README_JA.md">日本語</a> | <a href="README_KO.md">한국어</a> | <a href="README_ES.md">Español</a> | <a href="README_FR.md">Français</a> | <a href="README_DE.md">Deutsch</a> | <a href="README_PT.md">Português</a> | <a href="README_RU.md">Русский</a> | <strong>繁體中文</strong>
</p>
...
> 名字來自 Cyberpunk 2077 的 Relic 晶片——一塊能儲存數位化人格的生物晶片。
> 但這個專案不是賽博龐克主題。它的主題是：**記住**。
...
| 模板 | 蒸餾對象 | 一句話 |
|------|---------|--------|
| 🧑 [人類](templates/human.md) | 任何人 | 把一個人的思考方式、說話習慣、行為模式裝進 Relic |
| 🐱 [寵物](templates/pet.md) | 貓、狗、任何陪伴過你的生命 | 你家的貓也能永生 |
| 💞 [關係](templates/relationship.md) | 兩個人之間的互動模式 | 不是蒸餾某個人，而是蒸餾你們之間的默契 |
| 🏢 [團隊文化](templates/team-culture.md) | 一個團隊的靈魂 | 人散了，但一起熬夜改 bug 的感覺還在 |
...
> 詳細匯出教學請見 [平台資料取得指南](docs/PLATFORM-GUIDE.md)
...
- ✅ **授權優先** — 在蒸餾他人之前，必須先通過[六問授權協議](soul-shield/consent-protocol.md)
- 🚫 **紅線清楚** — 不得用於騷擾、跟蹤、冒充他人。詳見[倫理紅線](soul-shield/ethics.md)
...
- 💬 QQ 群：**1098169092**（入群暗號：萬物皆可 Relic）
- 🐛 [提交 Bug](https://github.com/Ylsssq926/relic.skill/issues/new?template=bug_report.yml)
- 💡 [功能建議](https://github.com/Ylsssq926/relic.skill/issues/new?template=feature_request.yml)
...
| 專案 | 介紹 |
|------|------|
| [immortal-skill](https://github.com/agenmod/immortal-skill) | 開源數位永生框架，支援 12+ 平台資料蒸餾 |
| [ex-skill](https://github.com/therealXiaomanChu/ex-skill) | 前任蒸餾 Skill，情感顆粒度非常細 |
...
<p align="center">
  <strong>⭐ Star 一下，替自己的靈魂買份保險。</strong>
</p>

<p align="center">
  <em>真正的死亡，不是心跳停止，而是最後一個記得你的人，也把你忘了。</em>
</p>
